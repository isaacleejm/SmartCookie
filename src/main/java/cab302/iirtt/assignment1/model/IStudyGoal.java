...
public interface IStudyGoal {
     ...
     * @param studyGoalStatus
     * @param studyGoalPinned
     * @param dueDate
     * @param dateCreated
     * @param userID
     */
    abstract void newStudyGoal(String studyGoalTitle, String studyGoalDescription, String studyGoalPriority, boolean studyGoalStatus, boolean studyGoalPinned, String dueDate, String dateCreated, int userID);
    ...
    /**
     * Allows user to change study goal priority.
